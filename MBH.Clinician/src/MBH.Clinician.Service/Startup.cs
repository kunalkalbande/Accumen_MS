    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMassTransit(configure =>
            {
                configure.UsingRabbitMq((context, configurator) =>
                {
                    ...
                    x.UseRoutingKeyFormatter(context => "tenant-" + context.Message.TenantId.ToString() + ".clinicianItem");
                    });

                    configurator.Message<ClinicianItem>(x => x.SetEntityName("clinicianItem"));
                    configurator.Publish<ClinicianItem>(x => x.ExchangeType = ExchangeType.Direct);
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "MBH.Clinician.Service", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "MBH.Clinician.Service v1"));
            }
